package com.example.mylistview_f55121027_rosanti;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] dataname = {"Rosanti", "Cut Nyak Dien", "Ki Hajar Dewantara", "Moh Yamin", "Pattimura", "R A Kartini", "Sukarno"};
